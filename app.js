...
var currentTasksHolder=document.getElementById("current-tasks");//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    label.className="task label task-list__label";
    ...
    editButton.className="button task-list__edit";

    deleteButton.className="button task-list__delete";
...
var addTask=function(){
    ...
    currentTasksHolder.appendChild(listItem);
...
//for each list item
for (var i=0; i<currentTasksHolder.children.length;i++){

    //bind events to list items chldren(tasksCompleted)
    bindTaskEvents(currentTasksHolder.children[i],taskCompleted);
}
